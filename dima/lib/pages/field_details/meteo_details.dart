                    ...
                    child: Row(
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: Text(
                          '$minTemp°C', style:  TextStyle(fontSize: screenWidth * 0.04,fontWeight: FontWeight.bold, color: Colors.blue)
                        )
                        ),
                        ...
                        SizedBox(
                          ...
                          height: screenHeight * 0.13,
                          child: Text(
                            '$maxTemp°C', style: TextStyle(fontSize: screenWidth * 0.04, fontWeight: FontWeight.bold, color: Colors.red)
                          )
                        )
                      ],
                    ),
                  ),
                  Image(image:AssetImage('assets/images/$weatherCode.png'), width: screenWidth *0.12, height: screenWidth * 0.11),
                      ...
                      children: [
                        Container(
                          ...
                          child: Row(
                            children: [
                              Image(image: const AssetImage('assets/images/precipitations.png'), width: screenHeight * 0.05, height:screenHeight * 0.05),
                              Text('${dailyPrecipitation}mm', style: TextStyle(fontSize: screenHeight * 0.038)),                   
                            ],
                          ),
                          ),
                        Container(
                          ...
                          child: Row(
                            children: [
                              Text('$currentHumidity%', style: TextStyle(fontSize: screenHeight * 0.038, color: Colors.orange)),
                              Image(image: AssetImage('assets/images/humidity.png'), width: screenHeight * 0.05, height:screenHeight * 0.05),
                            ],
                          )
                        )
