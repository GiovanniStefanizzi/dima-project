...
class ThemeOptions {
  ...
  static ButtonStyle elevatedButtonStyleTablet (BuildContext context){
    return ElevatedButton.styleFrom(
      foregroundColor: Colors.black87, 
      backgroundColor: const Color.fromARGB(255, 153, 194, 162),
      //minimumSize: Size(88, 36),
  ...
  static InputDecoration inputDecorationTablet(String labelText, String hintText, BuildContext context){
    return InputDecoration(
      labelText: labelText,
      hintText: hintText,
      labelStyle: TextStyle(
